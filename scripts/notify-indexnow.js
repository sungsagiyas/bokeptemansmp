...
// --- Konfigurasi Anda ---
const YOUR_DOMAIN = 'https://bokeptemansmp.pages.dev'; // Ganti dengan domain Anda yang sebenarnya
const API_KEY_NAME = '3a3a80fb-33cc-42d5-a2d4-d6a662b8fd73'; // Ganti dengan GUID Anda
